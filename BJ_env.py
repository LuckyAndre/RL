...
def sum_hand(hand):  # Return current hand total
    ...
    Пример эпизода, когда в ходе раздачи было получено 4 туза и они считались по разному в зависимости от общей суммы карт:
    [2 + 3,      1,          1,          1,          8,          1,          10]
...
class BlackjackEnv(gym.Env):
    ...
    def __init__(self, natural=False, sab=False):
        ...
        self.observation_space = spaces.Tuple((spaces.Discrete(32), spaces.Discrete(11), spaces.Discrete(2))) # TODO Почему 32?
        self.seed()
    ...
    def seed(self, seed=None):
        self.np_random, seed = seeding.np_random(seed) # Думаю, что self.np_random(seed) возвращает генератор для списка с зафиксированным сидом и само значение сида
        return [seed]
    ...
    def _get_obs(self):
        return (sum_hand(self.player), self.dealer[0], usable_ace(self.player)) # TODO у дилера тоже лучше выводить сумму!
